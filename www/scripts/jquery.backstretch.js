...
;(function ($, window, undefined) {
  ...
  var Backstretch = function (container, images, options) {
    ...
    this.$container.find('.backstretch').remove(); //added by Chris
    this.$wrap = $('<div class="backstretch"><div class="backstretch-overlay"></div></div>').css(styles.wrap).appendTo(this.$container);
